...
return [
    ...
    */
    ...
    | para uma regra de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar nossos marcadores
    | de atributo de placeholder com algo mais amigável ao leitor, como
